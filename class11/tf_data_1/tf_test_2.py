...
a_files = tf.placeholder(tf.uint8)
b_files = tf.placeholder(tf.int32)
c_files = tf.placeholder(tf.int32)
...
with tf.Session() as sess:
    ...
    for i in range(10):
        ...
        sess.run(iterator.initializer, feed_dict={a_files: image, b_files: label, c_files: pixel})
        print(label)
